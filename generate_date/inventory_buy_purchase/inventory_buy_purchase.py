...
def generate_dates(start_date, end_date):
    ...
    :param end_date: when the data base freezes
    """
...
def generate_inventory_buy_purchase(games, customer, staff_id, games_buy_prices):
    """
    ...
    :param game_buy_prices: game prices
    """
    ...
    # each game with its invernory_ids
    big_lista = []
    for i in range(50):
...
if __name__ == "__main__":
  print(generate_inventory_buy_purchase(pd.read_csv('generate_date\game\game.csv'), 
                                         pd.read_csv('generate_date\customer_rental\customer.csv'),
                                         pd.read_csv('generate_date\create_staff_schedule\staff_schedule.csv', index_col=[0]),
                                         games_buy_prices))