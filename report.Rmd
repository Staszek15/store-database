...
Pracownikiem, który został w tym okresie najczęściej wyróżniony jest `r py$best_employee` , który tytuł ten otrzymał łącznie `r py$how_often` razy. Najwięcej odnotowanych sprzedaży obsłużonych przez jednego pracownika, czyli aż `r py$max_sales` wystąpiło `r py$date`, a pracownikiem tym był `r py$employee`.
