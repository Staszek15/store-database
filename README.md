...
<span class="red-text">Czerwony tekst</span>

Every <font color="blue">Niebieski tekst</font> *.csv* file contains a complete dataset that later is used to fill a table of the same name. 
